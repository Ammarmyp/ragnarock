  ...
  const painPoints = [
    {
      ...
      description:
        "Business ideas start as conversations, notes, and documents without structure.",
    },
    {
      title: "Teams fill in gaps",
      description:
        "Engineering interprets missing details and assumptions become implementation decisions.",
    },
    {
      title: "Mismatch appears late",
      description:
        "Product review exposes that shipped behavior does not match stakeholder intent.",
    },
    {
        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 md:py-24 lg:px-8 lg:py-28">
          <div className="max-w-5xl">
            ...
            <p className="mt-5 max-w-3xl text-lg leading-relaxed text-muted-foreground md:text-xl">
              Ragnarock guides business owners through structured clarification
              and document analysis, then delivers complete SRS output only when
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 md:py-20 lg:px-8">
        <div className="mb-8 flex flex-col gap-3">
          ...
          <p className="max-w-3xl text-muted-foreground md:text-lg">
            Projects break when intent is incomplete. Without a requirement
            validation gate, engineering is forced to guess, and rework becomes
            inevitable.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {painPoints.map((item, idx) => (
            <article
              key={item.title}
              className="rounded-2xl border border-border/70 bg-card/45 p-6 backdrop-blur-xl"
            >
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 md:py-20 lg:px-8">
        <div className="rounded-3xl border border-border/70 bg-card/40 p-6 backdrop-blur-xl md:p-8">
          ...
          <div className="mt-6 rounded-2xl border border-primary/25 bg-primary/10 p-4 text-sm text-muted-foreground">
            Clarification loop exits only when developers can implement without
            assumptions.
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 md:py-20 lg:px-8">
        <div className="relative flex flex-col items-center gap-6 overflow-hidden rounded-3xl border border-border/70 bg-card/45 px-6 py-12 text-center backdrop-blur-xl md:px-10">
          ...
          <p className="max-w-2xl text-base text-muted-foreground md:text-lg">
            Turn vague intent into complete, validated requirements before
